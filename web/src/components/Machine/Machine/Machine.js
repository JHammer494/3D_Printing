...
const DELETE_MACHINE_MUTATION = gql`
  mutation DeleteMachineMutation($id: Int!) {
    deleteMachine(id: $id) {
      id
    }
  }
  ...
  return (
    <>
      ...
      <nav className="rw-button-group">
        <Link
          to={routes.editMachine({ id: machine.id })}
        ...
        <button
          ...
          onClick={() => onDeleteClick(machine.id)}
        >
          Delete
        </button>
      </nav>
